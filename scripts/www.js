...
const afterAddingMeta = insertContent(
  data,
  "<link",
  `<meta http-equiv="Content-Security-Policy" content="default-src * data: gap: https://ssl.gstatic.com 'unsafe-eval' 'unsafe-inline'; style-src * 'unsafe-inline' https://fonts.googleapis.com; font-src * data: https://fonts.gstatic.com; media-src *; img-src * data: content:;">` +
